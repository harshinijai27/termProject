...
import static com.beans.StockApiBean1.API_KEY;
 ...
 public String showpurchase()
{
  System.out.print("user... displaywatchlist");
userService=new UserServiceImpl();
List<StockApiBean> showpurchase=userService.showpurchase();
FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("plist",showpurchase);
